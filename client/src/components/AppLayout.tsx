...
const navItems = [
  {
    ...
    screen: "Overview",
    description: "All agents overview & metrics",
  },
  {
    path: "/screen1",
    label: "Modal & Specialist",
    icon: Cpu,
    screen: "Screen 1",
    description: "Modal.com + SpecialistAgent",
  },
  {
    path: "/screen2",
    label: "RAG & Frontier",
    icon: Brain,
    screen: "Screen 2",
    description: "RAG + FrontierAgent + EnsembleAgent",
  },
  {
    path: "/screen3",
    label: "Scanner & Messenger",
    icon: Radio,
    screen: "Screen 3",
    description: "ScannerAgent + MessagingAgent",
  },
  {
    path: "/screen4",
    label: "Planner & Framework",
    icon: Bot,
    screen: "Screen 4",
    description: "AutonomousPlannerAgent + DealAgentFramework",
  },
  {
    path: "/screen5",
    ...
    icon: Trophy,
    screen: "Screen 5",
    description: "The Price Is Right Finale",
  },
  {
    path: "/test-scripts",
    label: "Test Scripts",
    icon: FlaskConical,
    screen: "Screen 7",
    description: "Run & view test scripts",
  },
  {
    path: "/settings",
    label: "Settings",
